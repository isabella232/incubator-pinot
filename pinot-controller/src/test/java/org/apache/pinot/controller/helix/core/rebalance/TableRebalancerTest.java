...
public class TableRebalancerTest {
  ...
  public void testDowntimeMode() {
    ...
    TableRebalancer.SingleSegmentAssignment assignment =
        TableRebalancer.getNextAssignment(currentInstanceStateMap, targetInstanceStateMap, 0);
    ...
    assignment = TableRebalancer.getNextAssignment(currentInstanceStateMap, targetInstanceStateMap, 0);
    assertEquals(assignment._instanceStateMap, targetInstanceStateMap);
  ...
  public void testOneMinAvailableReplicas() {
    ...
    TableRebalancer.SingleSegmentAssignment assignment =
        TableRebalancer.getNextAssignment(currentInstanceStateMap, targetInstanceStateMap, 1);
    assertEquals(assignment._instanceStateMap, targetInstanceStateMap);
    ...
    assignment = TableRebalancer.getNextAssignment(currentInstanceStateMap, targetInstanceStateMap, 1);
    assertEquals(assignment._instanceStateMap, targetInstanceStateMap);
    assertEquals(assignment._availableInstances, Collections.singleton("host1"));
    ...
    assignment = TableRebalancer.getNextAssignment(assignment._instanceStateMap, targetInstanceStateMap, 1);
    assertEquals(assignment._instanceStateMap, targetInstanceStateMap);
