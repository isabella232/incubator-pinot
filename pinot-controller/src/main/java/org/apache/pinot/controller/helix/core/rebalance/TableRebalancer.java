...
public class TableRebalancer {
  ...
  static Map<String, Map<String, String>> getNextAssignment(Map<String, Map<String, String>> currentAssignment,
    ...
    if (enableStrictReplicaGroup) {
      ...
      for (Map.Entry<String, Map<String, String>> entry : currentAssignment.entrySet()) {
        String segmentName = entry.getKey();
        nextAssignment.put(segmentName, getNextAssignment(entry.getValue(), targetAssignment.get(segmentName),
   ...
   */
  @VisibleForTesting
  static SingleSegmentAssignment getNextAssignment(Map<String, String> currentInstanceStateMap,
